            ...
            <div class="card-body">
                ...
                <form method="post" action="./?sec=iterativas04">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="texto" id="texto" rows="3" placeholder="Inserte el texto a analizar"><?php echo $data['input_texto'] ?? ''; ?></textarea>
                        <p class="text-danger small"><?php echo $data['errores']['texto'] ?? ''; ?></p>
                    </div>
                    <div class="mb-3">
